...
public class PPWeatherDB {
	...
	public List<Province> loadProvinces() {
		...
		if (cursor.moveToFirst()) {
			do {
				...
				province.setProvinceName(cursor.getString(cursor.getColumnIndex("provine_name")));
	...
	public List<City> loadCities(int provinceId) {
		...
		Cursor cursor = db.query("City", null, "id = ?", new String[] {String.valueOf(provinceId)}, null, null, null);
		if (cursor.moveToFirst()) {
			do {
				City city = new City();
	...
	public List<County> loadCounties(int cityId) {
		...
		Cursor cursor = db.query("County", null, "id = ?", new String[] {String.valueOf(cityId)}, null, null, null);
		if (cursor.moveToFirst()) {
			do {
